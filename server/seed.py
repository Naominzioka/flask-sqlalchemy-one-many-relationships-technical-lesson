...
with app.app_context():
    ...
    uri_onboarding = Onboarding(orientation=datetime.datetime(2023, 3, 27), employee_id=uri.id)
    tristan_onboarding = Onboarding(
        orientation=datetime.datetime(2020, 1, 20, 14, 30), forms_complete=True, employee_id=tristan.id
    )
