...
class Employee(db.Model):
    ...
    #relational mapping the employee to related reviews
    reviews = db.relationship('Review', back_populates="employee", cascade='all, delete-orphan')
    
    #relational mapping the employee to related onboarding
...
class Onboarding(db.Model):
    ...
    #relationship mapping the onboarding to the related employee
